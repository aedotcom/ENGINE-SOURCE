...
//------------------------------------------------------------------------------------------------------------------
				...
				if ( ( mode + 1 ) == _i_SCH_CLUSTER_Get_PathRun( side , Org_Main_Pointer , 10 , 3 ) ) {
					...
					//
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 14 , 3 , x % 100 );	// 현재 Mode로 사용한 Dummy의 Count1
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 14 , 4 , x / 100 );	// 현재 Mode로 사용한 Dummy의 Count2
					//
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 15 , 3 , 0 );			//
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 15 , 4 , 0 );			//
					//
					_i_SCH_CLUSTER_Set_PathRun( side , i , 14 , 3 , x % 100 );					// 현재 Mode로 사용한 Dummy의 Count1
					_i_SCH_CLUSTER_Set_PathRun( side , i , 14 , 4 , x / 100 );					// 현재 Mode로 사용한 Dummy의 Count2
					//
					...
					//
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 10 , 3 , mode + 1 );	// 현재 Mode로 사용한 Dummy의 Mode
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 14 , 3 , 0 );			// 현재 Mode로 사용한 Dummy의 Count1
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 14 , 4 , 0 );			// 현재 Mode로 사용한 Dummy의 Count2
					//
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 15 , 3 , 0 );			//
					_i_SCH_CLUSTER_Set_PathRun( side , Org_Main_Pointer , 15 , 4 , 0 );			//
					//
					_i_SCH_CLUSTER_Set_PathRun( side , i , 14 , 3 , 0 );						// 현재 Mode로 사용한 Dummy의 Count1
					_i_SCH_CLUSTER_Set_PathRun( side , i , 14 , 4 , 0 );						// 현재 Mode로 사용한 Dummy의 Count2
					//
					_i_SCH_CLUSTER_Set_PathRun( side , i , 15 , 3 , 0 );						//
					_i_SCH_CLUSTER_Set_PathRun( side , i , 15 , 4 , 0 );						//
				}
				//
				if ( mode == 2 ) { // wafer post
					_i_SCH_CLUSTER_Set_PathRun( side , i , 10 , 3 , ( rcpcheck > 0 ) ? cmd : cmd - 4 ); // 현재 Dummy의 다음 Mode
				}
				else {
					_i_SCH_CLUSTER_Set_PathRun( side , i , 10 , 3 , ( rcpcheck > 0 ) ? cmd : cmd - 8 ); // 현재 Dummy의 다음 Mode
				}
				//
				//==========================================================================================================
				if ( curnotuse == 1 ) {
...
//------------------------------------------------------------------------------------------------------------------
				...
				if ( ( mode + 1 ) == _i_SCH_CLUSTER_Get_PathRun( side , pointer , 10 , 3 ) ) {
					...
					//
					_i_SCH_CLUSTER_Set_PathRun( side , pointer , 14 , 3 , x % 100 );				// 현재 Mode로 사용한 Dummy의 Count1
					_i_SCH_CLUSTER_Set_PathRun( side , pointer , 14 , 4 , x / 100 );				// 현재 Mode로 사용한 Dummy의 Count2
					//
					...
					//
					_i_SCH_CLUSTER_Set_PathRun( side , pointer , 10 , 3 , mode + 1 );				// 현재 Mode로 사용한 Dummy의 Mode
					_i_SCH_CLUSTER_Set_PathRun( side , pointer , 14 , 3 , 0 );						// 현재 Mode로 사용한 Dummy의 Count1
					_i_SCH_CLUSTER_Set_PathRun( side , pointer , 14 , 4 , 0 );						// 현재 Mode로 사용한 Dummy의 Count2
					//
					_i_SCH_CLUSTER_Set_PathRun( side , pointer , 15 , 3 , 0 );						//
					_i_SCH_CLUSTER_Set_PathRun( side , pointer , 15 , 4 , 0 );						//
					//
				...
				//
				if ( mode == 0 ) { // lot Pre
					_i_SCH_CLUSTER_Set_PathRun( side , i , 10 , 3 , ( rcpcheck > 0 ) ? cmd : cmd - 1 ); // 현재 Dummy의 다음 Mode
				}
				else {
					_i_SCH_CLUSTER_Set_PathRun( side , i , 10 , 3 , ( rcpcheck > 0 ) ? cmd : cmd - 2 ); // 현재 Dummy의 다음 Mode
				}
				//
				//==========================================================================================================
			}
